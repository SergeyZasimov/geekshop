...
class UserAuthTestCase(TestCase):
    ...
    def test_user_login(self):
        ...
        self.assertEqual(response.status_code, self.success_status_code)
        client_login = self.client.login(username='django2', password='geekbrains')
        self.assertTrue(client_login)
    ...
    def test_user_register(self):
        ...
        activation_url = f'{settings.DOMAIN_URL}/auth/verify/{new_user_data["email"]}/{new_user.activation_key}/'
